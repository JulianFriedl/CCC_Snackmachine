...
public class level3 {
	...
	public static void main(String[] args) {
		...
		String fieldSize = args[0];
		
		String prefix = fieldSize.substring(0, 1);
		String suffix = fieldSize.substring(1);
		int suffixInt = Integer.parseInt(suffix);
		
		String[][] field = new String[suffixInt][suffixInt];
		
		String ABC = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
		for(int i = 0;i<suffixInt;i++) {
			
			for(int a = 0;a<suffixInt;a++) {
